  ...
  return (
    <div className="absolute inset-0 z-10">
      <div className="absolute inset-0 bg-scanner-overlay">
        <div className="absolute left-1/2 top-1/2 h-48 w-96 -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-lg border-2 border-scanner-highlight bg-transparent">
          {scanning && (
